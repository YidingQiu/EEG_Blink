classdef sscb2cbtCrossEntropy < nnet.internal.cnn.layer.ClassificationLayer
    ...
    methods
        function this = sscb2cbtCrossEntropy(name, numClasses, categories, ...
    ...
    methods (Access = private)
        function assertValidInputSize(this, X)
...
internalWeights = shiftdim(weights(:), 2-obsDim);
end
